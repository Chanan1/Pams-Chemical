...
export default function Home() {
  ...
  return (
    <div className="font-sans">
      {/* 1. HERO SECTION */}
      <section className="relative overflow-hidden bg-[#F8FAFC] text-[#1E293B] border-b border-[#CBD5E1]">
          ...
          <div className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
                ...
                >
                  Pima Kimagro Sejahtera menyediakan pasokan bahan baku kimia industri murni standar internasional untuk pabrik deterjen, manufaktur kosmetik, pangan, farmasi, dan pengolahan air di seluruh Indonesia.
                </motion.p>
              ...
              <div className="lg:col-span-5 relative flex justify-center">
                ...
                >
                  <motion.div
                    ...
                    className="overflow-hidden rounded-[1.75rem] border border-[#E2E8F0] mb-6 h-56 relative"
                  >
                    <motion.img
                      src="/images/quality_lab.png"
                      alt="Laboratorium Quality Control"
                    ...
                    <div className="absolute left-4 bottom-4">
                      <p className="text-xs uppercase tracking-[0.28em] text-slate-100/80">Visualisasi Pasokan Kimia</p>
                      <h3 className="text-lg font-bold text-white">Lab QC + Pengiriman Cepat</h3>
                    </div>
                  </motion.div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between pb-4 border-b border-[#E2E8F0]">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xxs text-slate-500 font-semibold tracking-wider uppercase">Pima Kimagro Center</p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <p className="text-sm text-slate-600 leading-relaxed">
                        Kami memadukan armada distribusi, laboratorium QC, dan dukungan spesifikasi agar setiap pengiriman bahan kimia Anda selalu tepat dan sesuai standar.
                      </p>
                      <div className="grid gap-3 bg-[#F8FAFC] p-4.5 rounded-2xl border border-[#334155]/10">
                        <div className="flex items-start gap-3">
                          <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-[#00A896]" />
                          <p className="text-sm text-slate-600">Konsultasi formula dan spesifikasi produk kimia</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-[#0A3663]" />
                          <p className="text-sm text-slate-600">Dokumen MSDS, COA, serta TDS tersedia lengkap</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-[#F59E0B]" />
                          <p className="text-sm text-slate-600">Pengiriman nasional dengan status terpantau</p>
                        </div>
                      </div>
                    </div>
      ...
      <section className="bg-white py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-[2rem] border border-[#E2E8F0] shadow-2xl">
            <img
              src="/Banner/Banner.png"
              alt="Pima Kimagro Banner"
              className="w-full h-80 sm:h-[420px] object-cover object-center"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0A3663]/90 via-[#0A3663]/30 to-transparent" />
            <div className="absolute inset-x-0 bottom-0 p-6 sm:p-10 bg-gradient-to-t from-black/40 via-black/10 to-transparent">
              <p className="text-sm text-[#D8F3E2] uppercase tracking-[0.24em] font-semibold mb-3">
                Solusi Bahan Baku Kimia Industri
              </p>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white max-w-3xl">
                Pima Kimagro Sejahtera: Mitra Pasokan Kimia Industri dengan Jaringan Nasional
              </h2>
              <p className="mt-4 text-sm sm:text-base text-[#E2E8F2] max-w-2xl leading-relaxed">
                Temukan pilihan bahan baku kimia yang lengkap, mulai dari surfactants hingga teknik formula untuk deterjen, kosmetik, farmasi, dan pengolahan air.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, idx) => (
              <motion.div
                ...
                className="flex flex-col sm:flex-row items-center text-center sm:text-left space-y-2 sm:space-y-0 sm:space-x-4 bg-white p-5 rounded-2xl border border-[#E2E8F0] shadow-sm"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {highlights.map((item, idx) => (
              <motion.div
                ...
                whileHover={{ y: -4, boxShadow: "0 20px 40px rgba(10,54,99,0.12)" }}
                className="bg-white p-8 rounded-2xl border border-[#E2E8F0] transition-all duration-300 group"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white rounded-2xl border border-[#E2E8F0] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((cat, idx) => (
              <motion.div
                ...
                viewport={{ once: true, amount: 0.2 }}
                transition={{ duration: 0.55, delay: idx * 0.08 }}
                whileHover={{ y: -5, boxShadow: "0 24px 44px rgba(10,54,99,0.12)" }}
                className="bg-white p-8 rounded-2xl border border-[#E2E8F0] flex flex-col justify-between transition-all duration-300"
              >
      ...
      <motion.section
        ...
        className="py-24 bg-[#F8FAFC] text-[#1E293B] relative overflow-hidden"
      >
        {/* Background graphic */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
          <motion.h2
            ...
            className="text-3xl sm:text-5xl font-black tracking-tight leading-tight text-[#0A3663]"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-4.5 pt-4"
          >
            <Link
              href="/kontak?type=quote"
