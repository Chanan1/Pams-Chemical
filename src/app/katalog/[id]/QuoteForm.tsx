      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              disabled
              className="w-full px-3.5 py-2.5 rounded-xl border border-gray-150 dark:border-gray-800 bg-gray-100 dark:bg-gray-900/60 text-sm text-gray-500 dark:text-gray-400 font-semibold cursor-not-allowed"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`w-full px-3.5 py-2.5 rounded-xl border ${
                errors.quantity ? "border-red-500 ring-1 ring-red-500/20" : "border-gray-200 dark:border-gray-700"
              } bg-white dark:bg-gray-950 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/25 focus:border-blue-500 text-gray-900 dark:text-white transition-all`}
            />
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/25 focus:border-blue-500 text-gray-900 dark:text-white transition-all resize-none"
          />
        </div>
        ...
        {showSuccess && (
          ...
          >
            <motion.div
              ...
              className="w-14 h-14 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-lg shadow-emerald-500/30"
            >
