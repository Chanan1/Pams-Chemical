      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-6">
            <h2 className="text-xl font-bold text-[#1E293B] pb-3 border-b border-[#E2E8F0]">
              Informasi Kontak Kantor Pusat
            </h2>
            
            <div className="grid grid-cols-1 gap-4">
              {/* Address */}
              <div className="flex items-start space-x-3.5 p-5 rounded-2xl bg-white border border-[#E2E8F0]">
                <MapPin className="w-5.5 h-5.5 text-[#0A3663] shrink-0 mt-0.5" />
              ...
              {/* Phone & WA */}
              <div className="flex items-start space-x-3.5 p-5 rounded-2xl bg-white border border-[#E2E8F0]">
                <Phone className="w-5.5 h-5.5 text-[#0A3663] shrink-0 mt-0.5" />
                <div className="space-y-1">
              ...
              {/* Email */}
              <div className="flex items-start space-x-3.5 p-5 rounded-2xl bg-white border border-[#E2E8F0]">
                <Mail className="w-5.5 h-5.5 text-[#0A3663] shrink-0 mt-0.5" />
                <div className="space-y-1">
              ...
              {/* Operating Hours */}
              <div className="flex items-start space-x-3.5 p-5 rounded-2xl bg-white border border-[#E2E8F0]">
                <Clock className="w-5.5 h-5.5 text-[#0A3663] shrink-0 mt-0.5" />
                <div className="space-y-1">
                  <h4 className="font-bold text-sm text-[#1E293B]">Jam Operasional</h4>
                  <p className="text-xs text-slate-600">
                    Senin - Jumat | 08.00 - 17.00 WIB
                  </p>
                  <p className="text-xxs font-bold text-slate-500">
        ...
        <div className="lg:col-span-7 bg-[#F8FAFC] p-8.5 rounded-3xl border border-[#E2E8F0] shadow-sm relative">
          <div className="space-y-2 mb-6">
            ...
            <h3 className="text-xl font-bold text-[#1E293B]">Formulir Kontak B2B</h3>
            <p className="text-xs text-slate-600">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {/* Phone */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">No. WhatsApp / Telepon *</label>
                <input
                  type="text"
                  name="phone"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700 font-sans">Kebutuhan Utama *</label>
                <select
                  name="inquiryType"
                  value={formData.inquiryType}
                  onChange={handleChange}
                  className="w-full px-3.5 py-2.5 rounded-xl border border-[#E2E8F0] bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#0A3663]/25 focus:border-[#0A3663] text-[#1E293B] transition-all"
                >
              ...
              {formData.inquiryType === "quote" && (
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Nama Produk yang Diminta *</label>
                  <input
                    type="text"
                    name="product"
                    ...
                    className={`w-full px-3.5 py-2.5 rounded-xl border ${
                      errors.product ? "border-red-500 ring-1 ring-red-500/20" : "border-[#E2E8F0]"
                    } bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#0A3663]/25 focus:border-[#0A3663] text-[#1E293B] transition-all`}
                  />
            ...
            {/* Message */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-700">Pesan Inquiry *</label>
              <textarea
                name="message"
                rows={4}
                ...
                className={`w-full px-3.5 py-2.5 rounded-xl border ${
                  errors.message ? "border-red-500 ring-1 ring-red-500/20" : "border-[#E2E8F0]"
                } bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#0A3663]/25 focus:border-[#0A3663] text-[#1E293B] transition-all resize-none`}
              />
          ...
          <AnimatePresence>
            {showSuccess && (
              ...
              >
                <div className="w-14 h-14 rounded-full bg-[#00A896] text-white flex items-center justify-center shadow-lg">
  ...
  return (
    <Suspense fallback={
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
            ...
            <p className="text-slate-600 font-semibold font-sans">Memuat portal kontak...</p>
      </div>
    }>
      <ContactFormContent />
    </Suspense>
